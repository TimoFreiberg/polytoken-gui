//! The worktree index: pantoken's record of the jj/git worktrees it created, keyed by
...
impl WorktreeStore {
    ...
    /// The worktree pantoken created (or once created) at this path (== a session cwd),
